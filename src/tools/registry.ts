...
const BUILTIN_TOOLS: ToolDefinition[] = [
  ...
  { name: "type", category: "browser", description: "Type text into an element", parameters: [{ name: "selector", type: "string", required: true, description: "CSS selector" }, { name: "value", type: "string", required: true, description: "Text to type" }], verificationStrategy: "output", mutating: true, requiresApproval: false },
  ...
  { name: "visual_type", category: "vision", description: "Type by visual description", parameters: [{ name: "description", type: "string", required: true, description: "Element description" }, { name: "value", type: "string", required: true, description: "Text to type" }], verificationStrategy: "output", mutating: true, requiresApproval: false },
