...
const PLATFORMS: PlatformCheck[] = [
  ...
  { name: "Instagram", urlTemplate: "https://www.instagram.com/{}/", existsIndicator: "bodyContains", bodyMatch: "\"@", category: "social" },
  { name: "Pinterest", urlTemplate: "https://www.pinterest.com/{}/", existsIndicator: "bodyContains", bodyMatch: "pinterestapp:strong", category: "social" },
  ...
  { name: "Steam", urlTemplate: "https://steamcommunity.com/id/{}", existsIndicator: "status200", notFoundSignature: "The specified profile could not be found", category: "gaming" },
  ...
  { name: "PyPI", urlTemplate: "https://pypi.org/user/{}/", existsIndicator: "bodyContains", bodyMatch: "Projects maintained", category: "dev" },
  { name: "Docker Hub", urlTemplate: "https://hub.docker.com/u/{}", existsIndicator: "status200", category: "dev" },
  { name: "StackOverflow", urlTemplate: "https://stackoverflow.com/users/?tab=accounts&SearchText={}", existsIndicator: "bodyContains", bodyMatch: "user-details", category: "dev" },
  ...
  { name: "HackerRank", urlTemplate: "https://www.hackerrank.com/rest/contests/master/hackers/{}/profile", existsIndicator: "status200", category: "dev" },
  ...
  { name: "Juejin", urlTemplate: "https://juejin.cn/user/{}", existsIndicator: "bodyContains", bodyMatch: "user-name", category: "dev" },
  { name: "V2EX", urlTemplate: "https://www.v2ex.com/member/{}", existsIndicator: "status200", notFoundSignature: "不存在", category: "dev" },
...
async function checkPlatform(platform: PlatformCheck, username: string): Promise<UsernameResult> {
  ...
  try {
    const response = await fetch(url, {
      method: (platform.existsIndicator === "bodyContains" || platform.notFoundSignature) ? "GET" : "HEAD",
